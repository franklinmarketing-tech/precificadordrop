  ...
  shopee: [
    ...
    {nome:'Cadastrar em massa', img:'assets/img/ic-base-shop.webp',
     ...
     itens:['O arquivo da Shopee tem 51 colunas e seis linhas de cabeçalho',
            'Sai com o preço calculado no lugar do custo',
            'Aproveita nome, SKU, EAN, NCM, medidas e a URL da imagem',
            'Corta o nome em 120 caracteres e ignora EAN que não é código de barras',
            'Categoria e campos fiscais ficam em branco — são decisão sua']},
